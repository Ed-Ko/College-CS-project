...
def config(hosts, switches, routers, DHCPServer):
    ...
    hosts['h2'].cmd('route add default gw 192.168.1.125')

    hosts['h3'].cmd('ifconfig h3-eth0 192.168.1.66/26')
    hosts['h3'].cmd('route add default gw 192.168.1.125')
    ...
    routers['r1'].cmd('ifconfig r1-eth2 192.168.1.125/26')
    ...
    #routers['r1'].cmd('route add -net 192.168.1.64/26 gw 192.168.1.63')
    #routers['r1'].cmd('route add -net 192.168.1.0/26 gw 192.168.1.126')
    ...
    routers['r3'].cmd('route add -net 192.168.1.64/24 gw 10.0.0.1')
    ...
    routers['r4'].cmd('route add -net 192.168.1.64/24 gw 10.0.2.1')
